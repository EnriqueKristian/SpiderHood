...
-- EXEC con parámetros posicionales no acepta una expresión "viva" como
-- SYSDATETIME() directo -- sólo constantes o variables. Se calcula una sola
-- vez acá y se pasa @Now en cada llamada (mismo instante para todas las filas
-- que toca este script, que es lo esperado para un "UpdatedAt" de una misma
-- operación).
...
EXEC UPD_MenuItem
    ...
    3, 1, 'Conciliacion de Gastos', 'success', @Now;
...
EXEC UPD_MenuItem
    ...
    NULL, 4, 1, 'Multas y Moras', 'danger', @Now;
...
EXEC UPD_MenuItem
    ...
    'ReportIncident', NULL, 5, 1, NULL, NULL, @Now;
...
EXEC UPD_MenuItem
    ...
    'bi-info-circle', 'About', NULL, 11, 1, NULL, 'danger', @Now;
